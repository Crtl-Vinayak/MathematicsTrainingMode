package com.example.android.mathematicstrainingmode.LevelSelectionExerciseNum;
...
import com.example.android.mathematicstrainingmode.ExerciseNum.ExerciseTen;
import com.example.android.mathematicstrainingmode.R;
import com.example.android.mathematicstrainingmode.TrainingModeBeginScreen;

public class LevelSelectionExerciseTen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_level_selection_exercise_ten);
        ...
        for (int i = 0; i < 33; i++) {
            ...
            _buttonLevel[(i * 3)].setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Intent intent = new Intent(LevelSelectionExerciseTen.this, ExerciseTen.class);
        ...
        _backButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(LevelSelectionExerciseTen.this, TrainingModeBeginScreen.class);
                startActivity(intent);
            }
        });
    }
